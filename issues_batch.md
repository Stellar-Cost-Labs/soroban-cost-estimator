# 📋 Soroban Cost Estimator — 125 Meaningful Issues Backlog

> **Based on the [Drips Wave Issue Creation Framework](https://www.drips.network/blog/posts/creating-meaningful-issues)**
>
> Every issue in this backlog is structured with clear **Context & Background**, specific **Acceptance Criteria**, concrete **Implementation Hints**, **Repo-Specific Verification Notes**, explicit **Out-of-Scope Boundaries**, and transparent **Complexity & Point Weighting**.

---

## 📊 Summary & Points Distribution

| Category | Range | Issue Count | Primary Complexity |
|:---|:---:|:---:|:---|
| **1. CLI Features & Developer Experience** | #28–#52 | 25 | Trivial (100 pts) & Medium (150 pts) |
| **2. RPC & Network Reliability** | #53–#67 | 15 | Medium (150 pts) & High (200 pts) |
| **3. WASM Analysis & Inspection** | #68–#77 | 10 | Medium (150 pts) & Trivial (100 pts) |
| **4. Reporting, Visualizations & Formats** | #78–#92 | 15 | Trivial (100 pts) & Medium (150 pts) |
| **5. Caching, Persistence & Storage** | #93–#102 | 10 | Medium (150 pts) & High (200 pts) |
| **6. Config Snapshot & Drift Detection** | #103–#112 | 10 | Trivial (100 pts) & Medium (150 pts) |
| **7. Testing & Quality Assurance** | #113–#127 | 15 | Medium (150 pts) & High (200 pts) |
| **8. Documentation & Guides** | #128–#137 | 10 | Trivial (100 pts) & Medium (150 pts) |
| **9. CI/CD, DevOps & Automation** | #138–#142 | 5 | Medium (150 pts) & Trivial (100 pts) |
| **10. Architecture & Code Quality** | #143–#152 | 10 | Trivial (100 pts) & Medium (150 pts) |
| **Total Backlog** | **#28–#152** | **125 Issues** | **100% Drips Compliant** |

---


## CLI Features & Developer Experience (Issues #28–52)

### #28 — feat(cli): add `--verbose` flag for debug output

**Labels:** `enhancement, complexity: trivial, Stellar Wave`  
...
- Preserve integer-only arithmetic for fee calculations (stroops/i64).
- Ensure error handling uses `AppError` variants with clear context.
...
2. Open a PR referencing this issue (`Closes #28`).
3. Ensure CI is green and request maintainer review.

---
### #29 — feat(cli): add `--output` flag to write results to a file
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #29`).
3. Ensure CI is green and request maintainer review.

---
### #30 — feat(cli): add shell completion generation subcommand
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #30`).
3. Ensure CI is green and request maintainer review.

---
### #31 — feat(cli): add `--no-cache` flag to skip cache reads and writes
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #31`).
3. Ensure CI is green and request maintainer review.

---
### #32 — feat(cli): add `--quiet` flag to suppress non-essential output
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #32`).
3. Ensure CI is green and request maintainer review.

---
### #33 — feat(cli): add `--version` flag with extended build metadata
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #33`).
3. Ensure CI is green and request maintainer review.

---
### #34 — feat(cli): add config file support (`config.toml`)

**Labels:** `enhancement, complexity: medium, Stellar Wave`  
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #34`).
3. Ensure CI is green and request maintainer review.

---
### #35 — feat(cli): add `config snapshot list` subcommand
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #35`).
3. Ensure CI is green and request maintainer review.

---
### #36 — feat(cli): add `config snapshot delete` subcommand
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #36`).
3. Ensure CI is green and request maintainer review.

---
### #37 — feat(cli): add `config snapshot diff` for offline snapshot comparison
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #37`).
3. Ensure CI is green and request maintainer review.

---
### #38 — feat(cli): add `--compare` flag to `estimate` showing cost delta vs previous estimate
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #38`).
3. Ensure CI is green and request maintainer review.

---
### #39 — feat(cli): add `--format` flag supporting table, json, csv, and markdown
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #39`).
3. Ensure CI is green and request maintainer review.

---
### #40 — feat(cli): add `estimate --diff` to compare two WASM files

**Labels:** `enhancement, complexity: high, Stellar Wave`  
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #40`).
3. Ensure CI is green and request maintainer review.

---
### #41 — feat(cli): add `config cache stats` subcommand
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #41`).
3. Ensure CI is green and request maintainer review.

---
### #42 — feat(cli): add `estimate --dry-run` to preview simulation parameters without RPC calls
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #42`).
3. Ensure CI is green and request maintainer review.

---
### #43 — feat(cli): add `config snapshot --auto` flag to snapshot on every estimate
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #43`).
3. Ensure CI is green and request maintainer review.

---
### #44 — feat(cli): add `estimate-all --json` with structured per-function results
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #44`).
3. Ensure CI is green and request maintainer review.

---
### #45 — feat(cli): add `config diff --exit-code` flag for CI drift detection
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #45`).
3. Ensure CI is green and request maintainer review.

---
### #46 — feat(cli): add interactive `--interactive` mode for function argument input
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #46`).
3. Ensure CI is green and request maintainer review.

---
### #47 — feat(cli): add `config cache export` to dump cache as JSON
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #47`).
3. Ensure CI is green and request maintainer review.

---
### #48 — feat(cli): add `config cache import` to restore cache from JSON
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #48`).
3. Ensure CI is green and request maintainer review.

---
### #49 — feat(cli): add `estimate --repeat N` for simulation benchmarking
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #49`).
3. Ensure CI is green and request maintainer review.

---
### #50 — feat(cli): add `--color` flag for terminal color control
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #50`).
3. Ensure CI is green and request maintainer review.

---
### #51 — feat(cli): add `config diff --summary` for concise one-line output
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #51`).
3. Ensure CI is green and request maintainer review.

---
### #52 — feat(cli): add `estimate --watch` mode for continuous re-estimation on file changes
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #52`).
3. Ensure CI is green and request maintainer review.

---

## RPC & Network Reliability (Issues #53–67)

### #53 — fix(rpc): add exponential backoff on transient RPC failures

**Labels:** `bug, network, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #53`).
3. Ensure CI is green and request maintainer review.

---
### #54 — feat(rpc): add configurable request timeout (`--timeout`)

**Labels:** `enhancement, network, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #54`).
3. Ensure CI is green and request maintainer review.

---
### #55 — feat(rpc): add HTTP connection pooling with keep-alive

**Labels:** `enhancement, performance, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #55`).
3. Ensure CI is green and request maintainer review.

---
### #56 — feat(rpc): add `--rpc-url` validation before simulation
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #56`).
3. Ensure CI is green and request maintainer review.

---
### #57 — feat(rpc): add retry with configurable max attempts (`--max-retries`)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #57`).
3. Ensure CI is green and request maintainer review.

---
### #58 — feat(rpc): add request/response payload logging in debug mode
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #58`).
3. Ensure CI is green and request maintainer review.

---
### #59 — feat(rpc): add `rpc health` command to check network endpoint status
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #59`).
3. Ensure CI is green and request maintainer review.

---
### #60 — feat(rpc): add support for custom HTTP headers (`--header`)

**Labels:** `enhancement, network, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #60`).
3. Ensure CI is green and request maintainer review.

---
### #61 — feat(rpc): add client-side rate limiting to prevent RPC 429 throttling
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #61`).
3. Ensure CI is green and request maintainer review.

---
### #62 — feat(rpc): add in-memory caching for repeated config setting fetches

**Labels:** `enhancement, performance, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #62`).
3. Ensure CI is green and request maintainer review.

---
### #63 — feat(rpc): add `--connect-timeout` separate from total request timeout
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #63`).
3. Ensure CI is green and request maintainer review.

---
### #64 — feat(rpc): add network latency tracking and reporting
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #64`).
3. Ensure CI is green and request maintainer review.

---
### #65 — feat(rpc): add support for WebSocket RPC endpoint subscriptions

**Labels:** `enhancement, network, complexity: high, Stellar Wave`  
**Complexity:** **High (200 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #65`).
3. Ensure CI is green and request maintainer review.

---
### #66 — feat(rpc): add failover to secondary fallback RPC endpoint (`--rpc-fallback-url`)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #66`).
3. Ensure CI is green and request maintainer review.

---
### #67 — feat(rpc): add request deduplication for batch function simulations
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #67`).
3. Ensure CI is green and request maintainer review.

---

## WASM Analysis & Inspection (Issues #68–77)

### #68 — feat(wasm): validate `--arg` values against contract spec types

**Labels:** `enhancement, wasm, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #68`).
3. Ensure CI is green and request maintainer review.

---
### #69 — feat(wasm): detect and display WASM entry points and memory structure
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #69`).
3. Ensure CI is green and request maintainer review.

---
### #70 — feat(wasm): compute and display SHA-256 hash before simulation

**Labels:** `enhancement, wasm, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #70`).
3. Ensure CI is green and request maintainer review.

---
### #71 — feat(wasm): support `contractmeta` custom section parsing
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #71`).
3. Ensure CI is green and request maintainer review.

---
### #72 — feat(wasm): add WASM section size breakdown summary
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #72`).
3. Ensure CI is green and request maintainer review.

---
### #73 — feat(wasm): add `--wasm-info` command to display contract metadata without RPC
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #73`).
3. Ensure CI is green and request maintainer review.

---
### #74 — feat(wasm): add WASM memory limit validation against Soroban protocol constraints
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #74`).
3. Ensure CI is green and request maintainer review.

---
### #75 — feat(wasm): add batch support for evaluating multiple WASM files
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #75`).
3. Ensure CI is green and request maintainer review.

---
### #76 — feat(wasm): detect WASM compression and recommend `soroban contract optimize`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #76`).
3. Ensure CI is green and request maintainer review.

---
### #77 — feat(wasm): extract and display contract spec docs from `contractspecv0`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #77`).
3. Ensure CI is green and request maintainer review.

---

## Reporting, Visualizations & Formats (Issues #78–92)

### #78 — feat(report): human-readable config setting names in all outputs

**Labels:** `enhancement, ux, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #78`).
3. Ensure CI is green and request maintainer review.

---
### #79 — feat(report): add fee breakdown percentage columns to cost reports
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #79`).
3. Ensure CI is green and request maintainer review.

---
### #80 — feat(report): add aggregated cost summary line at the end of `estimate-all`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #80`).
3. Ensure CI is green and request maintainer review.

---
### #81 — feat(report): add historical cost trend comparison in cost reports
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #81`).
3. Ensure CI is green and request maintainer review.

---
### #82 — feat(report): add resource limit warnings when nearing maximum network constraints

**Labels:** `enhancement, ux, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #82`).
3. Ensure CI is green and request maintainer review.

---
### #83 — feat(report): add actionable cost optimization suggestions
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #83`).
3. Ensure CI is green and request maintainer review.

---
### #84 — feat(report): add CSV export format for `estimate-all`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #84`).
3. Ensure CI is green and request maintainer review.

---
### #85 — feat(report): add Markdown table export for GitHub PR comments
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #85`).
3. Ensure CI is green and request maintainer review.

---
### #86 — feat(report): add ANSI color coding for pricing changes in `config diff`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #86`).
3. Ensure CI is green and request maintainer review.

---
### #87 — feat(report): add cost projection for batch invocations (e.g. 100x, 10k calls)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #87`).
3. Ensure CI is green and request maintainer review.

---
### #88 — feat(report): add min/max/avg fee range statistics in `estimate-all`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #88`).
3. Ensure CI is green and request maintainer review.

---
### #89 — feat(report): add simulation ledger sequence and age in reports
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #89`).
3. Ensure CI is green and request maintainer review.

---
### #90 — feat(report): add configurable output precision for XLM fee values (`--precision`)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #90`).
3. Ensure CI is green and request maintainer review.

---
### #91 — feat(report): add ASCII horizontal bar chart for fee breakdown in terminal
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #91`).
3. Ensure CI is green and request maintainer review.

---
### #92 — feat(report): add side-by-side cost report diff formatting
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #92`).
3. Ensure CI is green and request maintainer review.

---

## Caching, Persistence & Storage (Issues #93–102)

### #93 — feat(cache): implement LRU eviction for cache disk space management
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #93`).
3. Ensure CI is green and request maintainer review.

---
### #94 — feat(cache): add SQLite-backed cache storage backend

**Labels:** `enhancement, storage, complexity: high, Stellar Wave`  
**Complexity:** **High (200 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #94`).
3. Ensure CI is green and request maintainer review.

---
### #95 — feat(cache): add `config cache query` with search filters
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #95`).
3. Ensure CI is green and request maintainer review.

---
### #96 — feat(cache): add automatic cache invalidation on WASM file modification
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #96`).
3. Ensure CI is green and request maintainer review.

---
### #97 — feat(cache): enforce strict cross-network cache isolation

**Labels:** `bug, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #97`).
3. Ensure CI is green and request maintainer review.

---
### #98 — feat(cache): add cache warm-up command (`config cache warm`)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #98`).
3. Ensure CI is green and request maintainer review.

---
### #99 — feat(cache): add execution duration and simulation status metadata to cached entries
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #99`).
3. Ensure CI is green and request maintainer review.

---
### #100 — feat(cache): add cache TTL (time-to-live) configuration
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #100`).
3. Ensure CI is green and request maintainer review.

---
### #101 — feat(cache): add cache schema versioning and migration logic

**Labels:** `enhancement, storage, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #101`).
3. Ensure CI is green and request maintainer review.

---
### #102 — feat(cache): add `config cache verify` command to check cache integrity
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #102`).
3. Ensure CI is green and request maintainer review.

---

## Config Snapshot & Drift Detection (Issues #103–112)

### #103 — feat(config): add automatic snapshot on network protocol upgrade detection
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #103`).
3. Ensure CI is green and request maintainer review.

---
### #104 — feat(config): add snapshot history query with timestamp navigation (`config snapshot show`)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #104`).
3. Ensure CI is green and request maintainer review.

---
### #105 — feat(config): add `config diff --against-previous` for consecutive snapshot comparison
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #105`).
3. Ensure CI is green and request maintainer review.

---
### #106 — feat(config): add snapshot retention policy (`--retain <count|days>`)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #106`).
3. Ensure CI is green and request maintainer review.

---
### #107 — feat(config): add snapshot export and import commands for team collaboration
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #107`).
3. Ensure CI is green and request maintainer review.

---
### #108 — feat(config): add config setting value explanations and unit annotations
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #108`).
3. Ensure CI is green and request maintainer review.

---
### #109 — feat(config): add `config diff --pricing-only` filter flag
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #109`).
3. Ensure CI is green and request maintainer review.

---
### #110 — feat(config): add configurable config change notification thresholds
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #110`).
3. Ensure CI is green and request maintainer review.

---
### #111 — feat(config): add `config snapshot --validate` to check snapshot schema validity
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #111`).
3. Ensure CI is green and request maintainer review.

---
### #112 — feat(config): add config setting change history tracking log
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #112`).
3. Ensure CI is green and request maintainer review.

---

## Testing & Quality Assurance (Issues #113–127)

### #113 — test: add end-to-end integration tests for all CLI commands

**Labels:** `testing, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #113`).
3. Ensure CI is green and request maintainer review.

---
### #114 — test: add property-based tests for fee calculator using `proptest`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #114`).
3. Ensure CI is green and request maintainer review.

---
### #115 — test: add mock Soroban RPC server fixture for offline deterministic testing

**Labels:** `testing, network, complexity: high, Stellar Wave`  
**Complexity:** **High (200 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #115`).
3. Ensure CI is green and request maintainer review.

---
### #116 — test: add performance benchmarks for WASM parsing with `criterion`

**Labels:** `testing, performance, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #116`).
3. Ensure CI is green and request maintainer review.

---
### #117 — test: add snapshot tests for all table and report formats

**Labels:** `testing, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #117`).
3. Ensure CI is green and request maintainer review.

---
### #118 — test: add comprehensive edge-case tests for `xlm_to_stroops` string parsing
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #118`).
3. Ensure CI is green and request maintainer review.

---
### #119 — test: add unit tests for `parse_interval_secs` with all duration suffixes
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #119`).
3. Ensure CI is green and request maintainer review.

---
### #120 — test: add error propagation and exit code verification tests
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #120`).
3. Ensure CI is green and request maintainer review.

---
### #121 — test: add concurrent cache access and thread safety tests
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #121`).
3. Ensure CI is green and request maintainer review.

---
### #122 — test: add config diff test suite covering all configuration setting permutations
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #122`).
3. Ensure CI is green and request maintainer review.

---
### #123 — test: add XDR encoding/decoding roundtrip validation tests
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #123`).
3. Ensure CI is green and request maintainer review.

---
### #124 — test: add CLI help text and argument parsing assertion tests
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #124`).
3. Ensure CI is green and request maintainer review.

---
### #125 — test: add test suite for `config_snapshot::store::list_snapshots` filtering
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #125`).
3. Ensure CI is green and request maintainer review.

---
### #126 — test: add integration test for `watch` command graceful shutdown on SIGINT
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #126`).
3. Ensure CI is green and request maintainer review.

---
### #127 — test: add regression test for negative refundable fee edge cases with storage I/O
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #127`).
3. Ensure CI is green and request maintainer review.

---

## Documentation & Guides (Issues #128–137)

### #128 — docs: add comprehensive CLI command reference documentation

**Labels:** `documentation, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #128`).
3. Ensure CI is green and request maintainer review.

---
### #129 — docs: add architecture overview document with data flow diagrams

**Labels:** `documentation, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #129`).
3. Ensure CI is green and request maintainer review.

---
### #130 — docs: add troubleshooting guide for common RPC, WASM, and network errors
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #130`).
3. Ensure CI is green and request maintainer review.

---
### #131 — docs: add formal CHANGELOG.md following Keep a Changelog standard
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #131`).
3. Ensure CI is green and request maintainer review.

---
### #132 — docs: add migration guide from Stellar CLI (`stellar contract invoke --cost`)
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #132`).
3. Ensure CI is green and request maintainer review.

---
### #133 — docs: add CI/CD integration guide with copy-pasteable GitHub Actions workflows
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #133`).
3. Ensure CI is green and request maintainer review.

---
### #134 — docs: add network configuration and RPC provider reference directory
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #134`).
3. Ensure CI is green and request maintainer review.

---
### #135 — docs: add detailed Soroban fee calculation methodology document
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #135`).
3. Ensure CI is green and request maintainer review.

---
### #136 — docs: add Rustdoc API documentation for library crate consumers
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #136`).
3. Ensure CI is green and request maintainer review.

---
### #137 — docs: enhance CONTRIBUTING.md with step-by-step development guide and PR checklist
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #137`).
3. Ensure CI is green and request maintainer review.

---

## CI/CD, DevOps & Automation (Issues #138–142)

### #138 — ci: add mock RPC integration test pipeline to GitHub Actions

**Labels:** `ci, testing, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #138`).
3. Ensure CI is green and request maintainer review.

---
### #139 — ci: add automated release workflow with multi-platform binary assets

**Labels:** `ci, devops, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #139`).
3. Ensure CI is green and request maintainer review.

---
### #140 — ci: add dependency audit and security vulnerability scanning

**Labels:** `ci, security, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #140`).
3. Ensure CI is green and request maintainer review.

---
### #141 — ci: add multi-platform build matrix for Linux, macOS, and Windows

**Labels:** `ci, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #141`).
3. Ensure CI is green and request maintainer review.

---
### #142 — ci: add code coverage reporting with `cargo-tarpaulin` / `llvm-cov`
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #142`).
3. Ensure CI is green and request maintainer review.

---

## Architecture, Error Handling & Refactoring (Issues #143–152)

### #143 — refactor: extract reusable RPC retry and backoff helper

**Labels:** `refactor, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #143`).
3. Ensure CI is green and request maintainer review.

---
### #144 — refactor: enhance error reporting with structured error context and causes

**Labels:** `refactor, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #144`).
3. Ensure CI is green and request maintainer review.

---
### #145 — feat(logging): add structured logging with `tracing` and `tracing-subscriber`

**Labels:** `enhancement, refactor, complexity: medium, Stellar Wave`  
**Complexity:** **Medium (150 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #145`).
3. Ensure CI is green and request maintainer review.

---
### #146 — refactor: audit and eliminate all warnings under `clippy::pedantic`

**Labels:** `refactor, code-quality, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #146`).
3. Ensure CI is green and request maintainer review.

---
### #147 — refactor: consolidate CLI argument definitions into dedicated submodules
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #147`).
3. Ensure CI is green and request maintainer review.

---
### #148 — refactor: extract report formatting into a trait-based formatter system
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #148`).
3. Ensure CI is green and request maintainer review.

---
### #149 — refactor: add `#[must_use]` annotations to all pure calculation functions
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #149`).
3. Ensure CI is green and request maintainer review.

---
### #150 — refactor: standardize error message formatting across all modules

**Labels:** `refactor, ux, complexity: trivial, Stellar Wave`  
**Complexity:** **Trivial (100 pts)**
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #150`).
3. Ensure CI is green and request maintainer review.

---
### #151 — refactor: implement `Display` trait for all public domain types
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #151`).
3. Ensure CI is green and request maintainer review.

---
### #152 — refactor: extract shared snapshot diffing and network fetch logic
...
#### How to Claim and Submit
1. Comment on this issue saying you'd like to take it on; wait for a maintainer to assign you (avoids duplicated effort).
2. Open a PR referencing this issue (`Closes #152`).
3. Ensure CI is green and request maintainer review.
